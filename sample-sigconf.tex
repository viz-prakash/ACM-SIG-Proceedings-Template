% Comments from ACM template.  {is used for folding} -Vijay
...
\input{sections/acm-template-sections/sectioning-commands}

\input{sections/acm-template-sections/tables}

\input{sections/acm-template-sections/math-equations}

\input{sections/acm-template-sections/figures}
...
\input{sections/acm-template-sections/sigchi-extended-abstracts}
...
\input{sections/acm-template-sections/appendix}
